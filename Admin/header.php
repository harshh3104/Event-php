   ...
   <nav id="sidebar">
      <div class="sidebar_blog_1">
         ...
         <div class="sidebar_user_info">
            ...
            <div class="user_profle_side">
               ...
               <div class="user_info">
                  <h6><?php echo isset($_SESSION['mail']) ? $_SESSION['mail'] : 'Guest'; ?></h6>
               </div>
            </div>
         </div>
      </div>
      <div class="sidebar_blog_2">
         ...
         <ul class="list-unstyled components">
            ...
            <li>
               <a href="#events" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="material-icons white_color">assignment</i> <span>Events</span></a>
            ...
            <li>
               <a href="#users" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="material-icons white_color">assignment</i> <span>Users</span></a>
